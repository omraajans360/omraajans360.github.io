...
export function Footer(){return <footer className="footer"><div className="wrap footer-grid">
 ...
 <div><h3>Hizmetler</h3><Link href="/drone-cekimi">Drone Çekimi</Link><Link href="/drone-cekimi#hizmetler">Düğün & Nişan</Link><Link href="/drone-cekimi#hizmetler">Emlak & Gayrimenkul</Link><Link href="/drone-cekimi#hizmetler">Mekân & İşletme</Link><Link href="/qr-menu">QR Menü</Link></div>
 ...
 <div><h3>Hizmet Bölgesi</h3><p>Drone: İzmir ve çevresi</p><p>QR Menü: Türkiye geneli</p><Link href="/iletisim">Özel teklif alın →</Link></div>
