...
export function ContactForm({ defaultService = "" }: Props) {
  ...
  async function submit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setStatus("ok");
      setMsg("Talebiniz alındı. Projenizi inceleyip en kısa sürede sizinle iletişime geçeceğiz.");
      form.reset();
      setService("");
    } catch {
      setStatus("error");
      setMsg("Talebiniz gönderilemedi. Lütfen tekrar deneyin veya WhatsApp üzerinden bize ulaşın.");
    }
  }
  ...
  return <form className="contact-form" onSubmit={submit}>
    ...
    <small className="form-note">Talebinizi inceledikten sonra en kısa sürede sizinle iletişime geçiyoruz.</small>
  </form>;
}
