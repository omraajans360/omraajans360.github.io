...
export const metadata: Metadata = {
  ...
  description: "OMRAAJANS360 drone çekimi, tanıtım, QR Menü ve dijital marka sayfası hizmetleri için projenize özel teklif alın.",
...
export default async function Contact({ searchParams }: { searchParams: Promise<{ hizmet?: string | string[] }> }) {
  ...
  return <main className="contact-page">
    <section className="section wrap contact-head"><Eyebrow>İLETİŞİM & TEKLİF</Eyebrow><h1>Fikrinizi Anlatın.<br />Birlikte Hayata Geçirelim.</h1><p>Drone çekimi, tanıtım içerikleri, QR Menü veya Dijital Marka Sayfası projenizi bize anlatın. İhtiyacınızı değerlendirelim, size özel çözüm ve teklif hazırlayalım.</p></section>
