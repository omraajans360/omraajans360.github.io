...
export default function Home(){return <main>
 <section className="premium-hero"><div className="premium-hero-media"/><div className="premium-hero-shade"/><div className="wrap premium-hero-content"><Eyebrow>İZMİR MERKEZLİ · GÖRSEL İLETİŞİM</Eyebrow><h1>Hikâyenizi <span>Gökyüzünden</span> Anlatıyoruz.</h1><p>Drone çekimi, tanıtım içerikleri ve QR Menü çözümleriyle markanızı, mekânınızı ve hikâyenizi güçlü bir görsel dille sunuyoruz.</p><div className="hero-actions"><Link href="/iletisim?hizmet=Drone%20%C3%87ekimi" className="btn btn-gold">PROJENİZ İÇİN TEKLİF AL <span>→</span></Link><Link href="/drone-cekimi" className="btn btn-dark">HİZMETLERİ KEŞFET</Link></div><div className="hero-proof"><span>Projeye Özel Planlama</span><span>Profesyonel Çekim & Kurgu</span><span>Doğrudan İletişim</span><span>QR Menü · Türkiye Geneli</span></div></div></section>
 ...
 <section className="section premium-benefits home-benefits-premium"><div className="wrap"><div className="section-kicker"><Eyebrow>NEDEN OMRAAJANS360?</Eyebrow><div><h2>Kaliteli Üretim. Net Süreç.</h2><p>Sadece çekim değil; planlama, içerik üretimi, kurgu ve teslim sürecini birlikte yönetiyoruz.</p></div></div><div className="home-benefit-grid">{benefits.map(([title,desc],i)=><article className="home-benefit-card" key={title}><div className="home-benefit-top"><span className="benefit-no">0{i+1}</span><i>✦</i></div><h3>{title}</h3><p>{desc}</p></article>)}</div></div></section>
